    ...
    return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-center text-center px-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-red-500/10 rounded-full blur-[100px] opacity-70 animate-pulse" />
            </div>

            <div className="relative z-10 space-y-8 bg-white p-8 rounded-3xl border border-gray-100 shadow-2xl backdrop-blur-xl">
